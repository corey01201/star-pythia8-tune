...
# Analysis object: /STAR_2019_I1771348/d01-x01-y03
...
ax_xLabel = r'Leading jet $p_{T} [GeV/c]$'
ax_yLabel = r'$ \langle \frac{dN_{ch}}{d\eta d\phi} \rangle$'
ax_title  = r'Transverse region $p_{T} > 0.2$ [GeV/c]'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (5.0, 45.0)
yLims = (0.0, 3.5)
