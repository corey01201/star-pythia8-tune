...
# Analysis object: /STAR_2019_I1771348/d04-x01-y02
...
ax_yLabel = r'$ \langle p^{ch}_{T} \rangle$'
ax_title  = r'Transverse region $p_{T} > 0.5$ [GeV/c]'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (5.0, 45.0)
yLims = (0.0, 2.0)
...
exec(open(prefix+'d04-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd04-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd04-x01-y02.png'), format='PNG')
