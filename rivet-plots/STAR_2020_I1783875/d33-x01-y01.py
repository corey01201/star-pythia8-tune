...
# Analysis object: /STAR_2020_I1783875/d33-x01-y01
...
ax_title  = r'$R=0.2 ~ 25 < p_{T} < 30$ GeV/$c$'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 2.5)
...
exec(open(prefix+'d33-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd33-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd33-x01-y01.png'), format='PNG')
