...
xpoints = {
    ...
    'pp200pThatbins.yoda' : [0.25, 0.75, 1.25, 1.75],
}
xedges = {
    'Data' : [0.0, 0.5, 1.0, 1.5, 2.0],
    'pp200pThatbins.yoda' : [0.0, 0.5, 1.0, 1.5, 2.0],
}
ref_xerrs = [
...
yvals = {
    ...
    'pp200pThatbins.yoda' : [1.972376, 0.0, 0.0, 0.0],
}
xerrs = {
    'Data' : [
        [0.25, 0.25, 0.25, 0.25],
...
ratio0_yvals = {
    ...
    'pp200pThatbins.yoda' : [0.6824830449826988, 0.0, 0.0, 0.0],
}
ratio0_yerrs = {
    'Data' : [
    ...
    'pp200pThatbins.yoda' : [
        [0.008929411764705882, 0.0, 0.0, 0.0],
        [0.008929411764705882, 0.0, 0.0, 0.0],
    ],
}
