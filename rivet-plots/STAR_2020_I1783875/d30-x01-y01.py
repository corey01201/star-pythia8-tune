...
# Analysis object: /STAR_2020_I1783875/d30-x01-y01
...
ax_title  = r'$R=0.6 ~ 25 < p_{T} < 30$ GeV/$c$'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (1.0, 5.0)
yLims = (0.9, 11.0)
...
exec(open(prefix+'d30-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd30-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd30-x01-y01.png'), format='PNG')
