...
# Analysis object: /STAR_2020_I1783875/d34-x01-y01
...
ax_title  = r'$R=0.2 ~ 40 < p_{T} < 60$ GeV/$c$'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 2.0)
yLims = (0.9, 11.0)
...
exec(open(prefix+'d34-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd34-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd34-x01-y01.png'), format='PNG')
