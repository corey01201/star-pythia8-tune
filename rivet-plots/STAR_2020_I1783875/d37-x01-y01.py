...
# Analysis object: /STAR_2020_I1783875/d37-x01-y01
...
ax_xLabel = r'$R_{g}$'
ax_yLabel = r'$1/N_{jets}$'
ax_title  = r'$R=0.6 ~ 40 < p_{T} < 60$ GeV/$c$'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 6.5)
...
exec(open(prefix+'d37-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd37-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd37-x01-y01.png'), format='PNG')
