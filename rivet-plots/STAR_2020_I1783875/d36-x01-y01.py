...
# Analysis object: /STAR_2020_I1783875/d36-x01-y01
...
exec(open(prefix+'d36-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd36-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd36-x01-y01.png'), format='PNG')
