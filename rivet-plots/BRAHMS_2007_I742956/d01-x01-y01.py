...
# Analysis object: /BRAHMS_2007_I742956/d01-x01-y01
...
ax_yLabel = r'$\frac{1}{2\pi\bar{p_{T}}}\frac{d^2\sigma}{dp_{T}dy}\left[mb(GeV^{-2})c^3\right]$'
ax_title  = r'Invariant Cross Section for Pion$^+$ (y= 2.95)'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.35, 5.2)
yLims = (9.000000000000001e-09, 110.00000000000001)
