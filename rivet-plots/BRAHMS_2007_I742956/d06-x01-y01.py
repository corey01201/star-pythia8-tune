...
# Analysis object: /BRAHMS_2007_I742956/d06-x01-y01
...
ax_xLabel = r'$p_T \left[GeV\right]$'
ax_yLabel = r'$\frac{1}{2\pi{p_{T}}}\frac{d^2\sigma}{dp_{T}dy}\left[mb(GeV^{-2})c^3\right]$'
ax_title  = r'Invariant Cross Section for AntiProton (y= 2.95)'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.8, 4.2)
yLims = (9.000000000000001e-10, 1.1)
...
exec(open(prefix+'d06-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd06-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd06-x01-y01.png'), format='PNG')
