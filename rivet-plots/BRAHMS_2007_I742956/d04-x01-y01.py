...
# Analysis object: /BRAHMS_2007_I742956/d04-x01-y01
...
ax_title  = r'Invariant Cross Section for Kaon$^-$ (y= 2.95)'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.75, 5.2)
...
exec(open(prefix+'d04-x01-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd04-x01-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd04-x01-y01.png'), format='PNG')
