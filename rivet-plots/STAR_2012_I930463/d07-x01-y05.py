...
# Analysis object: /STAR_2012_I930463/d07-x01-y05
...
ax_yLabel = r'$\bar{p} / \pi^-$'
ax_title  = r'Ratio of $\bar{p} / \pi^{-}$ as function of $p_\perp$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (3.0, 15.0)
yLims = (0.0, 2.0)
...
exec(open(prefix+'d07-x01-y05__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd07-x01-y05.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd07-x01-y05.png'), format='PNG')
