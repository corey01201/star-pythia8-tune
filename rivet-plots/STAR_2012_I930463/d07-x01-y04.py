...
# Analysis object: /STAR_2012_I930463/d07-x01-y04
...
ax_yLabel = r'$p / \pi^+$'
ax_title  = r'Ratio of $p / \pi^{+}$ as function of $p_\perp$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (3.0, 15.0)
yLims = (0.0, 2.0)
...
exec(open(prefix+'d07-x01-y04__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd07-x01-y04.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd07-x01-y04.png'), format='PNG')
