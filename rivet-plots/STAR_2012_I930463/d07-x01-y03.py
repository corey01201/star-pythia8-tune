...
# Analysis object: /STAR_2012_I930463/d07-x01-y03
...
ax_yLabel = r'$K^- / K^+$'
ax_title  = r'Ratio of $K^{-} / K^{+}$ as function of $p_\perp$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (3.0, 15.0)
yLims = (0.0, 2.0)
...
exec(open(prefix+'d07-x01-y03__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd07-x01-y03.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd07-x01-y03.png'), format='PNG')
