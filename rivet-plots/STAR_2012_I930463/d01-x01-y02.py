...
# Analysis object: /STAR_2012_I930463/d01-x01-y02
# Timestamp: 08-10-2025 (02:59:01)
...
ax_xLabel = r'$p_\perp$ [GeV]'
ax_yLabel = r'$1/(2\pi) \, d^2N/(p_\perp dy dp_\perp)$ [GeV$^{-2}$]'
ax_title  = r'$\pi^-$ transverse momentum'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (3.0, 15.0)
yLims = (9e-11, 0.011000000000000001)

# TeX-friendly labels for the legend
labels = {
    'legend' : ([ r"Data", r"pp200pThatbins" ], r""),
}
...
exec(open(prefix+'d01-x01-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd01-x01-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd01-x01-y02.png'), format='PNG')
