...
# Analysis object: /STAR_2012_I930463/d01-x01-y03
...
exec(open(prefix+'d01-x01-y03__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd01-x01-y03.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd01-x01-y03.png'), format='PNG')
