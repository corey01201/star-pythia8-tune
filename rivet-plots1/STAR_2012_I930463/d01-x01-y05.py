...
# Analysis object: /STAR_2012_I930463/d01-x01-y05
...
ax_title  = r'$p$ transverse momentum'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (3.0, 15.0)
...
exec(open(prefix+'d01-x01-y05__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd01-x01-y05.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd01-x01-y05.png'), format='PNG')
