...
# Analysis object: /STAR_2012_I930463/d01-x01-y06
...
ax_title  = r'$\bar{p}$ transverse momentum'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (3.0, 15.0)
yLims = (9e-12, 0.00011000000000000002)

# TeX-friendly labels for the legend
labels = {
    'legend' : ([ r"Data", r"pp200GeV" ], r""),
}
...
exec(open(prefix+'d01-x01-y06__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd01-x01-y06.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd01-x01-y06.png'), format='PNG')
